...
class FirebaseDataException extends PoemDataException {
  const FirebaseDataException([super.message = 'A Firestore error occurred.']);
}

class DataPermissionException extends PoemDataException {
  const DataPermissionException([super.message = 'Permission denied.']);
}

class DataUnavailableException extends PoemDataException {
  const DataUnavailableException([super.message = 'Service unavailable.']);
}
